...
<body>
    <div class="container">
        ...
        <form action="{{ route('postings.store') }}" method="POST" enctype="multipart/form-data" id="postingForm">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="file-input-wrapper">
                    ...
                    <input type="file" id="images" name="images[]" accept="image/jpeg,image/png,image/gif,image/webp"
                        multiple>
                </div>
                @error('images.*')
                    <span class="error">{{ $message }}</span>
            ...
            <button type="submit" class="btn">Create Posting</button>
        </form>
    </div>
